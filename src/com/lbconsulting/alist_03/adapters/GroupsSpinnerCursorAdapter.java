...
public class GroupsSpinnerCursorAdapter extends CursorAdapter {

	public GroupsSpinnerCursorAdapter(Context context, Cursor c, int flags) {
		super(context, c, flags);
		MyLog.i("GroupsSpinnerCursorAdapter", "GroupsSpinnerCursorAdapter constructor.");
	}
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		case R.id.llGroupRow:
			...
			if (tvGroupRow != null) {
				tvGroupRow.setText(cursor.getString(cursor.getColumnIndexOrThrow(GroupsTable.COL_GROUP_NAME)));
			}
			break;
		case R.id.llGroupRowDropdown:
			...
			if (tvGroupRowDropdown != null) {
				tvGroupRowDropdown.setText(cursor.getString(cursor.getColumnIndexOrThrow(GroupsTable.COL_GROUP_NAME)));
			}
			break;
		default:
			break;
